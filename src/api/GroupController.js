...
class GroupController {
    ...
    static groupAdd = async (groupAddRequest) => {
        return api.post(this.groupAddUrl, groupAddRequest, {withCredentials: true});
    }
    ...
    static groupAdminUpdate = async (groupUpdateRequest) => {
        return api.put(this.groupAdminUpdateUrl, groupUpdateRequest, {withCredentials: true});
    }
    ...
    static groupUserJoin = async (groupJoinRequest) => {
        return api.post(this.groupUserJoinUrl, groupJoinRequest, {withCredentials: true});
    }
    ...
    static groupUserUpdate = async (groupUserUpdateRequest) => {
        return api.put(this.groupUserUpdateUrl, groupUserUpdateRequest,{withCredentials: true});
    }
    ...
    static groupAdminUserAdd = async (groupAdminUserAddRequest) => {
        return api.post(this.groupAdminUserAddUrl, groupAdminUserAddRequest, {withCredentials: true});
    }
    ...
    static groupAdminUserUpdate = async (groupUserUpdateRequest) => {
        return api.put(this.groupAdminUserUpdateUrl, groupUserUpdateRequest, {withCredentials: true})
    }
